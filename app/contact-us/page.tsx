   ...
   <div className="absolute inset-0 bg-[#0000004D] z-10 rounded-[1rem] sm:rounded-[1.5rem]"/>
      ...
      <div className="relative z-10 container mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-16 sm:py-20 md:py-24 lg:py-80">
        ...
        <div className='w-full bg-white/20 backdrop-blur-md rounded-xl py-4 sm:py-6 md:py-12 lg:py-16 px-3 sm:px-4 md:px-8 lg:px-16 xl:px-24 border border-white/10'>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-3 sm:gap-4 md:gap-6 lg:gap-7 mb-3 sm:mb-4 md:mb-6">

            {/* Contact Form */}
            <div 
              className="rounded-xl p-3 sm:p-4 md:p-6 lg:p-8 lg:col-span-1"
              style={{
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-3 sm:space-y-4 md:space-y-6">
                ...
                <div>
                  <input
                    ...
                    className="w-full bg-[#FFFFFF5C] rounded-full px-4 py-2.5 sm:px-6 sm:py-3 md:py-4 text-right text-black placeholder:text-black/70 text-sm sm:text-base focus:outline-none focus:ring-2 focus:ring-[#F9BD65] transition-all font-semibold"
                    dir="auto"
                  />
                  {errors.name && (
                ...
                <div>
                  <input
                    ...
                    className="w-full bg-[#FFFFFF7F] rounded-full px-4 py-2.5 sm:px-6 sm:py-3 md:py-4 text-right text-black placeholder:text-black/70 text-sm sm:text-base focus:outline-none focus:ring-2 focus:ring-[#F9BD65] transition-all font-semibold"
                    dir="auto"
                  />
                  {errors.phone && (
                ...
                <div>
                  <textarea
                    ...
                    rows={4}
                    className="w-full bg-[#FFFFFF5C] rounded-3xl px-4 py-2.5 sm:px-6 sm:py-3 md:py-4 text-right text-black placeholder:text-black/70 text-sm sm:text-base focus:outline-none focus:ring-2 focus:ring-[#F9BD65] transition-all resize-none font-semibold"
                    dir="auto"
                  />
                  {errors.message && (
                ...
                <button
                  ...
                  className="w-full bg-[#E6A81699] hover:bg-[#E6A81699] rounded-full px-4 py-2.5 sm:px-6 sm:py-3 md:py-4 text-[#fcfbee] text-sm sm:text-base md:text-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed font-bold"
                >
            ...
            <div className='lg:col-span-2 flex flex-col gap-2 sm:gap-3 md:gap-4 lg:gap-6 h-full'>
              <div className='grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3 md:gap-4 lg:gap-6 h-full'>
                              {/* Headquarters Contact Card */}
              <div className="bg-[#FFFFFF33] backdrop-blur-sm rounded-xl p-2.5 sm:p-3 md:p-4 lg:p-5 xl:p-6 border border-white/10">
                <div className="flex flex-col items-center mb-3 sm:mb-4 md:mb-6">
                  <div className="bg-[#614D1F99] rounded-full p-1.5 sm:p-2 md:p-3 mb-2 sm:mb-3 md:mb-4">
                  ...
                  <h3 className="text-base sm:text-lg font-bold text-white text-center font-iranyekan">
                    دفتر مرکزی
                  </h3>
                </div>
                ...
                <div className="space-y-2 sm:space-y-3 md:space-y-4">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <p className="text-xs sm:text-sm md:text-base font-bold text-white text-right flex-1 font-iranyekan leading-relaxed">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <p className="text-xs sm:text-sm md:text-base font-bold text-white font-iranyekan">
                      ۰۲۶-۳۶۱۰۸۵۰۰
                    </p>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <p className=" text-sm sm:text-base font-bold text-white text-right font-iranyekan">
                      ساعت ۸ صبح تا ۱۷
                      <br />
                      با هماهنگی قبلی
                    </p>
              ...
              <div className="bg-[#FFFFFF33] backdrop-blur-sm rounded-xl p-3 sm:p-4 md:p-6 lg:p-8 border border-white/10">
                <div className="flex flex-col items-center mb-3 sm:mb-4 md:mb-6">
                  <div className="bg-[#614D1F99] rounded-full p-1.5 sm:p-2 md:p-3 mb-2 sm:mb-3 md:mb-4">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M9.99998 10.4167C11.3807 10.4167 12.5 9.29737 12.5 7.91666C12.5 6.53594 11.3807 5.41666 9.99998 5.41666C8.61927 5.41666 7.49998 6.53594 7.49998 7.91666C7.49998 9.29737 8.61927 10.4167 9.99998 10.4167Z" stroke="#F9BD65" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round" />
                ...
                <div className="space-y-2 sm:space-y-3 md:space-y-4">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <p className="text-sm sm:text-base font-bold text-white text-right flex-1 font-iranyekan">
              ...
              {/* Social Media Bar */}
              <div 
                className="rounded-xl p-2.5 sm:p-3 md:p-4 lg:p-5 xl:p-6 sm:col-span-2 h-fit"
                style={{
                  background: 'rgba(255, 255, 255, 0.05)',
                  backdropFilter: 'blur(39px) saturate(180%)',
                  WebkitBackdropFilter: 'blur(39px) saturate(180%)',
              ...
              >
                <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 md:gap-6 lg:gap-8">
                  ...
                  <a
                    ...
                    className="bg-white rounded-full px-3 py-1.5 sm:px-4 sm:py-2 md:px-6 md:py-3 flex items-center gap-1.5 sm:gap-2 md:gap-3 hover:bg-gray-100 transition-colors"
                  >
                    ...
                    <p className="text-[10px] sm:text-xs md:text-sm font-bold text-black font-iranyekan">
          ...
          {/* Map Section */}
          <div 
            className="rounded-xl p-2 sm:p-2.5 md:p-3 lg:p-4 mb-3 sm:mb-4 md:mb-6 lg:mb-8 xl:mb-12"
            style={{
              background: 'rgba(255, 255, 255, 0.05)',
              backdropFilter: 'blur(39px) saturate(180%)',
              WebkitBackdropFilter: 'blur(39px) saturate(180%)',
          ...
          >
            <div className="relative w-full h-40 sm:h-48 md:h-64 lg:h-80 xl:h-96 rounded-xl sm:rounded-2xl overflow-hidden">
              <DarkMap
                latitude={35.8481}
                longitude={50.9540}
