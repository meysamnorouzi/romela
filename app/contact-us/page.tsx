              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                ...
                <div>
                  <input
                    ...
                    className="w-full bg-[#FFFFFF5C] rounded-full px-6 py-3 sm:py-4 text-right text-black placeholder:text-black/70  text-sm sm:text-base focus:outline-none focus:ring-2 focus:ring-[#F9BD65] transition-all font-semibold"
                    dir="auto"
                  />
                  {errors.name && (
                ...
                <div>
                  <input
                    ...
                    className="w-full bg-[#FFFFFF7F] rounded-full px-6 py-3 sm:py-4 text-right text-black placeholder:text-black/70  text-sm sm:text-base focus:outline-none focus:ring-2 focus:ring-[#F9BD65] transition-all font-semibold"
                    dir="auto"
                  />
                  {errors.phone && (
                ...
                <div>
                  <textarea
                    ...
                    rows={4}
                    className="w-full bg-[#FFFFFF5C] rounded-3xl px-6 py-3 sm:py-4 text-right text-black placeholder:text-black/70  text-sm sm:text-base focus:outline-none focus:ring-2 focus:ring-[#F9BD65] transition-all resize-none font-semibold"
                    dir="auto"
                  />
                  {errors.message && (
            ...
            <div className='lg:col-span-2 flex flex-col gap-4 sm:gap-6 h-full'>
              ...
              <div className="bg-[#FFFFFF33] backdrop-blur-sm rounded-xl p-4 sm:p-5 md:p-6 border border-white/10">
                <div className="flex flex-col items-center mb-6">
                  ...
                  <h3 className=" text-lg font-bold text-white text-center font-iranyekan">
                    دفتر مرکزی
                  </h3>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <p className=" text-sm sm:text-base font-bold text-white font-iranyekan">
                      ۰۲۶-۳۶۱۰۸۵۰۰
                    </p>
                  </div>
              ...
              <div className="bg-[#FFFFFF33] backdrop-blur-sm rounded-xl p-4 sm:p-5 md:p-6 border border-white/10 sm:col-span-2 h-fit">
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 md:gap-8">
                  ...
                  >
                    ...
                    <p className="text-xs sm:text-sm font-bold text-black font-iranyekan">
